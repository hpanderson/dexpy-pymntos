...
jupyter nbconvert --to notebook --ClearOutputPreprocessor.enabled=True --ExecutePreprocessor.enabled=True
jupyter nbconvert --to slides dexpy-demo.ipynb --template output_toggle --reveal-prefix=reveal.js
